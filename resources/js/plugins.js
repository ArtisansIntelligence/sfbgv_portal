/*================================================================================
  Item Name: ScreenFacts - Material Design Admin Template
  Version: 5.0
  Author: PIXINVENT
...
$(function () {
   ...
   $('.datepicker').datepicker({
      ...
      container: 'body',
      onDraw: function () {
         // ScreenFacts select dropdown not proper working on mobile and tablets so we make it browser default select
