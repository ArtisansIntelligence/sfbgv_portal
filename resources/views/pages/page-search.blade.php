              ...
              <div class="row">
                <div class="col l8 m12 mb-5">
                  <div class="result">
                    ...
                    <p>Mar 15, 2018 - Buy ScreenFacts - Material Design Admin Template by PIXINVENT on ThemeForest.
                      ScreenFacts is a Material Design Admin Template</p>
                  </div>
                  <div class="row mt-3">
                      ...
                      <div class="row">
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            ...
                            <div class="card-content">
                              ScreenFacts is a Material Design Admin Template.
                      ...
                      <div class="row">
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            ...
                            <div class="card-content">
                              ScreenFacts admin is super flexible, powerful, clean.
                              <p class="teal-text lighten-2 truncate">www.youtube.com</p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col s12">
                          <div class="card z-depth-0 grey lighten-4 border-radius-6">
                            ...
                            <div class="card-content">
                              ScreenFacts admin includes 8 pre-built templates.
                              <p class="teal-text lighten-2 truncate">www.youtube.com</p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="result mt-5">
                    <h6><a href="#">RockOn ScreenFacts css Admin Template Dashboard</a></h6>
                    <p class="teal-text lighten-2">pixinvent.com/materialize-v1.0/layout-fullscreen.html</p>
