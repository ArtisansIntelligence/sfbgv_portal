      ...
      <div id="chips-styles" class="card card-default">
        <div class="card-content">
          <div class="row">
            ...
            <div class="col s12">
              <p>You can also style it easily with ScreenFacts admin theme pre defined color set classes.
              </p>
              <div class="section">
      ...
      <div id="tags-two" class="card card-default">
        <div class="card-content">
          <div class="row">
            ...
            <div class="col s12">
              <p>You can also style tag chips easily with ScreenFacts admin theme pre defined color set
                classes.</p>
              <div class="section">
                <div class="chip cyan white-text">
                  Tag
