  ...
  <nav
    ...
    <div class="nav-wrapper">
      ...
      <div class="header-search-wrapper hide-on-med-and-down">
        ...
        <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Explore ScreenFacts"
      ...
      <div class="nav-wrapper">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm" type="search" required="" placeholder='Explore ScreenFacts' id="search"
              data-search="template-list">
          ...
          <li>
            <a @if(isset($menu->submenu)){{'class=dropdown-menu'}} @endif href="{{$menu->url}}" data-target="{{$menu->activate}}">
              ...
              <span>
                ...
                <span class="dropdown-title">{{ $menu->name}}</span>
                @isset($menu->submenu)
