    ...
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="{{asset('/')}}">
        @if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType']))
          ...
          <img class="hide-on-med-and-down" src="{{asset('images/screenfacts-logo.png')}}" alt="materialize logo" />
          <!-- <img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset($configData['smallScreenLogo'])}}"alt="materialize logo" /> -->
          <img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset('images/screenfacts-logo.png')}}"alt="materialize logo" />
