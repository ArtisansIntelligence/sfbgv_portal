...
// Dashboard Route
Route::get('/', [DashboardController::class, 'dashboardModern'])->middleware('auth');
Route::get('/dashboard', [DashboardController::class, 'dashboardModern'])->middleware('auth');

Route::get('/clients', [ClientController::class, 'clientsList'])->middleware('auth');
Route::get('/client-onboarding', [ClientController::class, 'createClient'])->middleware('auth');
Route::post('/add-client', [ClientController::class, 'addClient'])->middleware('auth');
...
// Route::get('/candidate', [CandidateController::class, 'candidateList']);
// Route::get('/create-candidate', [CandidateController::class, 'createCandidate']);
Route::post('/add-candidate', [CandidateController::class, 'addCandidate']);
Route::post('/update-candidate', [CandidateController::class, 'updateCandidate']);
Route::post('/delete-candidate', [CandidateController::class, 'deleteCandidate']);

Route::get('/import-candidate', [CandidateController::class, 'importCandidate']);
Route::get('/export-candidate', [CandidateController::class, 'exportCandidate']);
Route::get('/view-candidate', [CandidateController::class, 'viewCandidate']);

Route::get('/candiate-form/[:token]', [CandidateController::class, 'candidateForm']);
Route::post('/update-candiate-details/[:token]', [CandidateController::class, 'updateCandidateDetails']);
